...
For the 24px logical model, the default corner radius is **4px**. For the default Baijiahao 48px PC team master, scale it to **8px** unless mature-library precedent or visual fit requires a smaller radius.
