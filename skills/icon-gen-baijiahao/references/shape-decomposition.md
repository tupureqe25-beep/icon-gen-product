...
```jsonc
{
  ...
  // Stroke (inherits output profile defaults — 2px logical or 4px team-master; specify only for documented exceptions)
  "stroke": {
    "weight": 2,
    "color": "#242529",
    "position": "center-or-inner-by-output-profile",
    "cap": "round",
    "join": "round"
  },

  // Fill — null by default; local tiny fill allowed only for clarity exceptions
  "fill": null,                  // or { "color": "#242529", "reason": "3px dot would collapse with 2px stroke" }
...
```jsonc
{
  ...
  "x": 3, "y": 5, "w": 18, "h": 16,
  "r": 4,
  "stroke": { "weight": 2, "color": "#242529", "position": "center", "cap": "round", "join": "round" },
  "fill": null,
  "group": "root"
}
```
...
```
  ...
  4. CALCULATE COORDINATES
     ...
     Effective logical path range: usually 3–21px for compensated 2px center-stroke preview; official 48px output scales by 2 and prefers inner stroke where supported.
...
Concept examples:
  ...
  guide/shelf     → rect with top-center notch interrupted + AI rewrite tab inside
